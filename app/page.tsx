    ...
    <div className="min-h-screen bg-white text-zinc-900 selection:bg-primary/10 selection:text-primary">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-16 md:pt-24 pb-32">
        ...
        <div className="max-w-2xl mx-auto mb-12 space-y-4 text-left">
          ...
          {/* View More Toggle */}
          <details className="group bg-zinc-50 border border-zinc-100 rounded-2xl overflow-hidden shadow-sm transition-all duration-300">
            <summary className="flex items-center justify-between p-6 cursor-pointer hover:bg-zinc-100 transition-colors">
              <span className="font-bold text-sm md:text-base text-zinc-600 flex items-center gap-3">
                <div className="w-8 h-8 bg-zinc-200 rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-zinc-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                </div>
                이용 후기 더 보러 가기
              </span>
              <div className="flex items-center gap-2">
                <span className="text-xs text-zinc-400 group-open:hidden">더보기</span>
            ...
            <div className="p-6 pt-2 text-zinc-600 text-sm md:text-base leading-relaxed border-t border-zinc-100 break-keep space-y-6">
              <div className="bg-white/60 p-4 rounded-xl border border-zinc-100">
